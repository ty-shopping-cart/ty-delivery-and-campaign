...
@Component
public class AmountCoupon implements DiscountCoupon {

    private CouponRepository couponRepository;

    @Autowired
    public AmountCoupon(CouponRepository couponRepository) {
        this.couponRepository = couponRepository;
    }

    @Override
    public boolean isUsable(CouponCartDto couponCartDto) {
        Coupon coupon = couponRepository.findByIdAndCouponType(couponCartDto.getCouponId(), DiscountType.AMOUNT);
    ...
    public DiscountDto applyCoupon(CouponCartDto couponCartDto) {
        ...
        discountDto.setDiscount(coupon.getDiscountAmount());
